  ...
  return baseTemplate(
    ...
    <tr>
      <td style="padding:36px 40px 0;text-align:center" dir="rtl">
        <div style="width:56px;height:56px;border-radius:14px;background-color:#4F7CFF;margin:0 auto;text-align:center;line-height:56px">
          <span style="font-size:26px">✉️</span>
        </div>
        <h1 style="margin:20px 0 0;font-size:24px;font-weight:700;color:#0f172a">
          أكّد بريدك الإلكتروني
        </h1>
        <p style="margin:12px 0 0;font-size:15px;color:#475569;line-height:1.8">
          أهلاً ${safeName} — تم إنشاء حسابك في <strong style="color:#0f172a">SmartScholar</strong>.<br>
    ...
    <tr>
      <td style="padding:28px 40px 0;text-align:center">
        <a href="${confirmUrl}" style="display:inline-block;padding:14px 40px;font-size:15px;font-weight:600;color:#ffffff;background-color:#4F7CFF;border-radius:10px;text-decoration:none">
          تفعيل الحساب
        </a>
        <p style="margin:14px 0 0;font-size:13px;color:#94a3b8" dir="rtl">
    ...
    <tr>
      <td style="padding:24px 40px 0">
        <p style="margin:0 0 6px;font-size:12px;color:#94a3b8;text-align:center" dir="rtl">
          لو الزر مش شغال، انسخ الرابط ده في المتصفح:
        </p>
        <p style="margin:0;font-size:12px;color:#4F7CFF;word-break:break-all;text-align:center" dir="ltr">
          ${confirmUrl}
        </p>
      </td>
    </tr>
    <tr>
      <td style="padding:24px 40px 32px">
        <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#f8fafc;border-radius:10px">
          <tr>
            <td style="padding:18px" dir="rtl">
              <p style="margin:0;font-size:13px;color:#475569;line-height:1.8">
                <strong style="color:#0f172a">ليه التأكيد؟</strong>
        ...
        <p style="margin:18px 0 0;font-size:12px;color:#94a3b8;line-height:1.7;text-align:center" dir="rtl">
          لو مش إنت اللي عملت الحساب ده، تجاهل الرسالة ببساطة.
        </p>
        <p style="margin:10px 0 0;font-size:12px;color:#cbd5e1;line-height:1.6;text-align:center">
...
export function creditsAddedHtml(
  ...
  return baseTemplate(
    ...
    <tr>
      <td style="padding:28px 40px 0;text-align:center">
        <div style="width:56px;height:56px;border-radius:14px;background-color:#10b981;margin:0 auto;text-align:center;line-height:56px">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#f0fdf4;border:1px solid #bbf7d0;border-radius:10px">
          <tr>
            <td style="padding:20px;text-align:center">
              <p style="margin:0;font-size:14px;color:#166534">Credits added</p>
              <p style="margin:6px 0 0;font-size:32px;font-weight:700;color:#15803d">+${creditsAdded}</p>
    ...
    <tr>
      <td style="padding:24px 40px 32px;text-align:center">
        <a href="${siteUrl}/dashboard/documents"
           style="display:inline-block;padding:13px 28px;background-color:#2563eb;color:#ffffff;text-decoration:none;border-radius:8px;font-size:15px;font-weight:600">
          Review a document
        </a>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#fef2f2;border:1px solid #fecaca;border-radius:10px">
          <tr>
            <td style="padding:16px 20px">
              ...
              <p style="margin:6px 0 0;font-size:14px;color:#7f1d1d;line-height:1.5">${reason}</p>
            </td>
          </tr>
        </table>
      </td>
    ...
    .map(
      ...
      <tr>
        <td style="padding:14px 0;border-bottom:1px solid #e2e8f0">
          <p style="margin:0 0 4px;font-size:15px;font-weight:600;color:#0f172a">${i.step}</p>
          <p style="margin:0;font-size:13px;color:#64748b">${i.scholarshipName}</p>
          <p style="margin:6px 0 0;font-size:13px;color:${i.daysLeft <= 3 ? "#dc2626" : "#0d9488"};font-weight:600">
  ...
  return baseTemplate(
    ...
    <tr>
      <td style="padding:36px 40px 0" dir="rtl">
        <h1 style="margin:0 0 8px;font-size:22px;color:#0f172a">مرحباً ${name}</h1>
        ...
        <p style="margin:28px 0 0;text-align:center">
          <a href="${roadmapUrl}" style="display:inline-block;background-color:#0d9488;color:#ffffff;text-decoration:none;padding:13px 28px;border-radius:10px;font-size:15px;font-weight:600">
            عرض خطتي
          </a>
        </p>
        <p style="margin:24px 0 36px;font-size:12px;color:#94a3b8;text-align:center">
