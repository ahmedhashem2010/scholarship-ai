...
const STAR = (id: string, cx: number, cy: number, r: number) => {
  ...
  return (
    <path
      d={`M ${s(r1)} L ${p(r1 * 0.588, -r1 * 0.809)} ${p(r1 * 0.951, -r1 * 0.309)} ${p(r1 * 0.309, -r1 * 0.309)} ${p(r2, -r2)} ${p(-r1 * 0.309, -r1 * 0.309)} ${p(-r1 * 0.951, -r1 * 0.309)} ${p(-r1 * 0.588, -r1 * 0.809)} ${s(-r1)} ${p(-r1 * 0.588, r1 * 0.809)} ${p(-r1 * 0.951, r1 * 0.309)} ${p(-r1 * 0.309, r1 * 0.309)} ${p(-r2, r2)} ${p(r1 * 0.309, r1 * 0.309)} ${p(r1 * 0.951, r1 * 0.309)} ${p(r1 * 0.588, r1 * 0.809)} Z`}
      fill={`url(#${id})`}
    />
  );
};
