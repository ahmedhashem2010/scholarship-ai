...
export default function PrivacyPage() {
  return (
    <main className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
      <h1 className="text-h2 font-bold text-foreground mb-8">Privacy Policy</h1>
      <div className="prose prose-slate max-w-none space-y-6 text-sm text-muted-foreground leading-relaxed">
        <p><strong>Last updated:</strong> May 2026</p>

        <h2 className="text-h4 font-semibold text-foreground mt-8">1. Information We Collect</h2>
        ...
        <h2 className="text-h4 font-semibold text-foreground mt-8">2. How We Use Your Information</h2>
        ...
        <h2 className="text-h4 font-semibold text-foreground mt-8">3. Data Storage & Security</h2>
        ...
        <h2 className="text-h4 font-semibold text-foreground mt-8">4. Third-Party Services</h2>
        ...
        <h2 className="text-h4 font-semibold text-foreground mt-8">5. Your Rights</h2>
        <p>You have the right to access, correct, or delete your personal data at any time. Contact us to exercise these rights.</p>

        <h2 className="text-h4 font-semibold text-foreground mt-8">6. Contact</h2>
